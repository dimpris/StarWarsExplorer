...
import { useGetSpeciesDetailsQuery } from '../../services/redux/API.Service';
...
const SpeciesDetails: FC = () => {
  ...
  const {data, isFetching, isError} = useGetSpeciesDetailsQuery(itemId);
  ...
  return (
    <div className={ isFetching ? c_styles.Loading : c_styles.Loaded }>
      ...
      <h3>{name}</h3>
      <h4 style={{color: 'rgba(0, 0, 0, 0.6)'}}>(Species)</h4>
